...
void StageEditor::SetGroundObjectDirection(int32_t index, Quaternion direction) {
	assert(groundObjects_ <= index);
	groundObjects_[index].transform.rotate = direction;
}
