...
void Sprite_3D::Draw(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& commandList, Object_3D_Data& data) {
	...
	//左下
	vertexData_[0].position = { 0.0f,spriteHeight_ / kWindowHeight_,0.0f,1.0f };
	...
	//右下
	vertexData_[2].position = { spriteWidth_ / kWindowWidth_,spriteHeight_ / kWindowHeight_,0.0f,1.0f };
	vertexData_[2].texcoord = { 1.0f,1.0f };
	vertexData_[2].normal = { 0.0f,0.0f,-1.0f };
	//右上
	vertexData_[3].position = { spriteWidth_ / kWindowWidth_,0.0f,0.0f,1.0f };
	...
	Vector3 rotate = {
		-data.camera.transform.rotate.x + std::numbers::pi_v<float>,
		-data.camera.transform.rotate.y,
		0.0f
	};
